...
namespace sky::vk {
    ...
    {
        // Initialize pNext chain to nullptr
        enabledPhyIndexingFeatures.pNext = nullptr;
        ...
        if (enabledFeature.descriptorIndexing) {
            ...
            enabledPhyIndexingFeatures.runtimeDescriptorArray                    = VK_TRUE;
            enabledPhyIndexingFeatures.descriptorBindingVariableDescriptorCount  = VK_TRUE;
            enabledPhyIndexingFeatures.shaderSampledImageArrayNonUniformIndexing = VK_TRUE;
        ...
        if (enabledFeature.variableRateShading) {
            ...
            enabledShadingRateFeatures.attachmentFragmentShadingRate = VK_TRUE;
            enabledShadingRateFeatures.pipelineFragmentShadingRate   = VK_TRUE;
            enabledShadingRateFeatures.primitiveFragmentShadingRate  = VK_TRUE;
            enabledShadingRateFeatures.pNext = nullptr;
        ...
        if (enabledFeature.multiView) {
            ...
            enabledMvrFeature.multiview = VK_TRUE;
            enabledMvrFeature.pNext = nullptr;
            if (enabledFeature.variableRateShading) {
                enabledShadingRateFeatures.pNext = &enabledMvrFeature;
            } else {
                enabledPhyIndexingFeatures.pNext = &enabledMvrFeature;
            }
        ...
        if (enabledFeature.meshShader) {
            ...
            } else if (enabledFeature.variableRateShading) {
                enabledShadingRateFeatures.pNext = &enabledMeshShaderFeatures;
            } else {
                enabledPhyIndexingFeatures.pNext = &enabledMeshShaderFeatures;
            }
